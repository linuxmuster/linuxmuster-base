...
// $Id: e5c97f37af4b6749ffcb02bfe038bbbdcabd9b7c $
$conf['vhosts'] = false;
...
$conf['auth']['params']['basedn'] = 'ou=accounts,@@basedn@@';
...
$conf['group']['params']['basedn'] = 'ou=groups,@@basedn@@';
...
$conf['problems']['email'] = '@@wwwadmin@@@@@domainname@@';
